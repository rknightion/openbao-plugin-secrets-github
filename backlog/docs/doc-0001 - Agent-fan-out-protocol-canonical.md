...
> authoritative for openbao-plugin-secrets-github. It is deliberately not summarised, compressed or
> adapted — a compression drifts from its source while looking authoritative. An edit to the source
> is not finished until this copy is re-imported in the same change.
>
